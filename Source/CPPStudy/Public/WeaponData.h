...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Animation")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Sound")
	...
	/** Sound to play when start reloading */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Sound")
	TObjectPtr<USoundBase> ReloadStartSound = nullptr;

	/** Sound to play when end reloading */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Sound")
	TObjectPtr<USoundBase> ReloadEndSound = nullptr;
	...
	/** Damage per shot */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Combat", meta = (ClampMin = "0.0"))
	float Damage = 20.0f;
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Ammo", meta = (ClampMin = "0"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "AAA | Combat")
